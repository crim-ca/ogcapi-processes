...
[#table_service-implementations,reftext='{table-caption} {counter:table-num}']
...
[[sc_clients_components]]
=== Clients

[#table_client-implementations,reftext='{table-caption} {counter:table-num}']
