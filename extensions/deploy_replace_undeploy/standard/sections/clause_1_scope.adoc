...
[#table_endpoint-method-matrix,reftext='{table-caption} {counter:table-num}']
.Supported HTTP methods by resource
[cols="40,15,15,15,15",options="header"]
|===
|Resource endpoint 4+|HTTP method
| |**GET** |**POST** |**PUT** |**DELETE**
|`/processes`  |n/a |<<sc_deploy,deploy>> |n/a |n/a
|`/processes/{processID}` |n/a |n/a |<<sc_replace,replace>> |<<sc_undeploy,undeploy>>
|`/processes/{processID}/package` |<<sc_application-package,package>> |n/a |n/a |n/a
|===
