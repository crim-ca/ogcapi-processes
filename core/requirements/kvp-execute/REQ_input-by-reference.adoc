...
[.component,class=part]
--
If the input cardinality is greater than 1 then the value of the input parameter SHALL be encoded as a <<link-schema,link object>> and appropriately <<sc_kvp-execute_complex-value-input,URL-encoded>> to a string.
--
