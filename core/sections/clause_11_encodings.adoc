...
* <<sc_requirements-class-json,JSON>>
* <<sc_requirements-class-html,HTML>>

The <<sc_requirements-class-json,JSON>> requirements class defines the requirements for encoding Processes API request and response messages using https://tools.ietf.org/html/rfc8259[JSON].

The <<sc_requirements-class-json,HTML>> requirements class defines the requirements for encoding Processes API request and response messages using https://html.spec.whatwg.org/[HTML].
