...
[[sc_kvp-execute_operation]]
==== Operation

include::../requirements/kvp-execute/REQ_process-execute-op.adoc[]

[[sc_kvp-execute_parameters]]
==== Parameters

[[sc_kvp-execute_format-parameter]]
===== Format parameter
...
[[sc_kvp-execute_prefer-parameter]]
===== Prefer parameter
...
[[sc_kvp-execute_process-inputs]]
===== Process inputs

[[sc_kvp-execute_process-inputs-overview]]
====== Overview
...
<<sc_collection-input,Collection inputs>> are not defined for KVP-encoded execute requests.

[[sc_kvp-execute_simple-value]]
====== Simple string input
...
[[sc_kvp-execute_simple-numeric-input]]
...
[[sc_kvp-execute_simple-boolean-input]]
...
[[sc_kvp-execute_complex-value-input]]
...
[[sc_kvp-execute_array-value-input]]
====== Array-valued input
...
* a <<sc_kvp-execute_simple-value,simple value>>,
* a <<qualified-value,complex value>>,
* a <<sc_kvp-execute_binary-value,binary value>>,
...
[[sc_kvp-execute_input-cardinality]]
===== Input cardinality
...
[[sc_kvp-execute_process-outputs]]
===== Process outputs
...
[[sc_kvp-execute_response]]
=== Response

Whether a process is invoked using a <<req_core_process-execute-request,JSON-encoded request>> that is https://datatracker.ietf.org/doc/html/rfc7231#section-4.3.3[HTTP POST'ed] to the <<req_core_process-execute-op,execution endpoint>> or a URL-encoded request is used, the behavior of the server with regard to the response is the same.  The details of the response can be found in <<sc_process-execute_response>>.
