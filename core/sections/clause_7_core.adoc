...
|<<sc_landing-page,API Landing Page>>| https://www.opengis.net/spec/ogcapi-common-1/1.0/req/landing-page
|<<sc_api-definition,API Definition>>| https://www.opengis.net/spec/ogcapi-common-1/1.0/req/landing-page
|<<sc_conformance-classes,Declaration of Conformance Classes>>| https://www.opengis.net/spec/ogcapi-common-1/1.0/req/landing-page
|<<req_oas30_oas-definition,OpenAPI 3.0>>| https://www.opengis.net/spec/ogcapi-common-1/2.0/req/oas30
|<<sc_requirements-class-html,HTML>>| https://www.opengis.net/spec/ogcapi-common-1/2.0/req/html
|===
...
[[sc_landing-page_operation]]
==== Operation

include::../requirements/core/REQ_landingpage-op.adoc[]


[[sc_landing-page_response]]
==== Response
...
[[sc_landing-page_error-situations]]
==== Error situations
...
[[sc_api-definition_error-situations]]
==== Error situations

See <<http_status_codes>> for general guidance.

[[sc_conformance-classes]]
=== Declaration of conformance classes

[[sc_conformance-classes_operation]]
==== Operation
...
[[sc_conformance-classes_response]]
==== Response
...
[[sc_conformance-classes_error-situations]]
==== Error situations
...
[[sc_support-for-cross-origin-requests]]
...
[[sc_process-list_query-parameter-limit]]
...
[[sc_process-list_error-situations]]
==== Error situations
...
[[sc_process-description_operation]]
==== Operation

include::../requirements/core/REQ_process-description-op.adoc[]


[[sc_process-description_response]]
==== Response
...
[[sc_process-description_error-situations]]
==== Error situations
...
Depending on the description of the <<sc_process_description,process>> and the <<sc_execution_mode,negotiated process execution mode>>, process execution may result in the creation of a <<sc_job-results,job resource>>.


[[sc_process-execute_operation]]
==== Operation

include::../requirements/core/REQ_process-execute-op.adoc[]

[[sc_process-execute_request-body]]
==== Request body

[[sc_process-execute_content-schema]]
===== Content schema
...
[[sc_process-execute_inputs]]
===== Process inputs

[[sc_process-execute_inputs-overview]]
====== Overview
...
[[sc_process-execute_inputs-values]]
====== Input values
...
* a <<simple-literals,simple literal value>>,
* an <<arrays,array>>,
* a <<qualified-value,qualified value>>,
* a <<binary-value,binary value>>,
* or a <<bounding-box-value,bounding box>>.

NOTE: See also <<sc_collection-input>>.
...
In this second example, the property `geometryInput` has a cardinality of greater than 1 and value instances can be one of a number of enumerated media types.  The schema of `geometryInput` from the <<clause_process-description,OGC process description>> for the process might be:
...
[%unnumbered]
====
Consider a process input named `complexObjectInput` with the following definition from an <<clause_process-description,OGC process description>>:
...
For the purposes of validation, the server needs to only validate the component of the <<qualified-value,qualified value>> that is an instance of <<input-value-schema,value.yaml>> against the `schema` fragment from the <<clause_process-description,OGC process description>>.  Specifically, the validation target is:
...
NOTE: This example makes use of an <<clause_process-description,OGC process description>>.  However, any other process description vocabulary may be used and applied, for the purpose of validation, in a similar manner.
====
...
[[sc_process-execute_response]]
==== Response

[[sc_process-execute_response-overview]]
===== Overview
...
|See <<sc_process-execute_async-response,Response for asynchronous process execution>>
|===
...
[[sc_proces-execute_output-one-multi-value]]
===== Response requesting a single processing output with multiple values (`maxOccurs>1`)
...
[[sc_process-execute_output-many]]
...
[[sc_process-execute_output-many-omitted]]
...
[[sc_process-execute_output-many-empty]]
...
[[sc_process-execute_async-response]]
...
[[sc_process-execute_error-situations]]
==== Error situations
...
[[sc_job-status_operation]]
==== Operation

include::../requirements/core/REQ_job-op.adoc[]

[[sc_job-status_response]]
==== Response
...
[[sc_job-status_error-situations]]
==== Error situations
...
[[sc_job-results_operation]]
==== Operation

[[sc_job-results_output-all]]
...
[[sc_job-results_output-individual]]
...
[[sc_job-results_output-individual-nth]]
===== Individual processing results (maxOccurs>1)
...
[[sc_job-results_output-individual-0th]]
===== The "0-th" result
...
[[sc_job-results_response]]
==== Response

[[sc_job-results_overview]]
===== Overview
...
[[sc_job-results_error-situations]]
==== Error situations
