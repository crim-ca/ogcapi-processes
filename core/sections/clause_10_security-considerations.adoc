...
[[clause_security-considerations]]
...
* <<sc_job-status_info,Job status info>>
* <<sc_job-results,Job results>>
...
* <<sc_process-execute,Execute>>, HTTP POST

Requirements class "Dismiss"

* <<sc_job-dismiss,Dismiss>>, HTTP DELETE


[[sc_operations-using-http-get]]
...
* The process description contains all necessary information needed to execute a process. This information can be used to send a JSON <<execute-request-body,execute request>> to the Processes API endpoint that will pass initial sanity checks. For example, checks for the correct input/output identifiers.  The ability to pass values to the server is vulnerable to injection attacks and issues discussed in section <<sc_cons_execute>> can occur.
